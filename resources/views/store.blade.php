<!DOCTYPE html>
        ...
        <div class="book_container">
          <div id="book">
            ...
            $count = 0;
            @endphp
            @foreach($counter as $item =>$index )


            


            @if ((str_starts_with($item, 'الدرس')))
...
@if ($count != 0)
        ...
        <div class="top"><div align="center" class="اسم-الدرس">
          ...
          <p class="اسم-الدرس"><a name="مقدمة_لعلم_العروض">{{$item}} </a></p>
        ...
        <p class="فقرة"><a name="lesson-1B" class="عناصر"> {{trim($item, "A")}}</a>
